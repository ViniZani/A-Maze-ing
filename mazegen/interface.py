...
from mazegen.solver import solve_bfs, render_path
from mazegen.writer import write_data, write_hex_path, write_cord_path
...
def menu() -> None:
    ...
    while True:
        try:
            ...
            if order == "1":
                origin_coord = (config_data['origin'][1],
                                config_data['origin'][0])
                final_coord = (config_data['final'][1],
                               config_data['final'][0])
